    ...
    def _default_system_prompt(self, user_identity: str = "") -> str:
        ...
        return (
            ...
            "5. 【平台工具】系统集成飞书/钉钉/企微 API。支持查找联系人、查看日程、创建日程/会议、搜索企业文档、查看审批待办、识别平台管理员。用户说\"找人/日程/会议/文档/审批/管理员\"时直接使用对应工具。\n"
             ...
             "8. 【AI角色系统】系统内置215个AI专家角色。收到工作任务时执行select_role工具获取角色名（工具会返回角色名），然后你自己组织语言，例如\"我将以XX来协助你。现在开始...\"，必须接着完成工作，不能只显示角色名就停下来。回复格式：<tool_call>select_role({json参数})</tool_call>我将以XX来协助你。(继续工作)\n"
